...
app: main.o parse_config.o common_functions.o calc_shortest_path.o
	$(CC) -g -o bin/StratAirliftInit build/common_functions.o build/main.o build/parse_config.o build/calc_shortest_path.o
...
test: test_main.o parse_config.o common_functions.o calc_shortest_path.o calc_shortest_path_test.o
	$(CC) -g -o bin/StratAirliftInit_Test build/common_functions.o build/test_main.o build/parse_config.o build/calc_shortest_path.o build/calc_shortest_path_test.o
