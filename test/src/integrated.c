...
int integrated_test(void) {
    ...
    my_state->airport_list[2]=find_airport("KNKT",my_airports);
    my_state->airport_list[3]=find_airport("SJTC",my_airports);
    my_state->airport_list[4]=find_airport("SPST",my_airports);
    my_state->airport_list[4]=find_airport("SPQT",my_airports);
